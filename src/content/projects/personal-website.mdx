...
# When ENABLE_AUDIO is turned on (src/config.ts), re-add 'Web Audio API' here
# and the ambient-music mention to the description.
...
import { ENABLE_AUDIO } from '../../config';
...
{ENABLE_AUDIO && <AmbientAudioSection />}
