    ...
    <div className="relative carousel-container">
      ...
      <div className="relative carousel-wrapper">
        ...
        {showLeftArrow && (
          <button
            onClick={() => scroll('left')}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-30 w-12 h-12 rounded-full shadow-lg transition-all duration-200 hover:scale-110 opacity-0 flex items-center justify-center -ml-6"
        ...
        {showRightArrow && (
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-30 w-12 h-12 rounded-full shadow-lg transition-all duration-200 hover:scale-110 opacity-0 flex items-center justify-center -mr-6"
            style={{ backgroundColor: 'var(--bg-card)', color: 'var(--text-primary)' }}
